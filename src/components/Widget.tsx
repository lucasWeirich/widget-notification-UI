...
export default function Widget() {
  return <div className="w-[448px] rounded overflow-hidden">
    {/* Header */}
    <div className="bg-zinc-200 dark:bg-zinc-800 py-4 px-6 flex items-center justify-between">
      <span className="font-bold">Notificações</span>
      <button className="text-violet-500 font-bold text-xs uppercase hover:text-violet-400 transition">Marcar todas as vistas</button>
    </div>

    {/* Recent Section */}
    <div>
      <div className="bg-zinc-300 dark:bg-zinc-950 py-2 px-5 text-sm text-zinc-500 dark:text-zinc-400">
        Recentes
      </div>
      ...
      <div className='divide-y-2 divide-zinc-500 dark:divide-zinc-950'>
        ...
        <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
          ...
          <div className='flex gap-2 self-center'>
            <button className='w-8 h-8 rounded flex items-center justify-center bg-zinc-500 dark:bg-zinc-800'>
